...
#
for idx, (vk, modifiers) in list(HOTKEYS.items()):
    print("Registering id", idx, "for key", vk)
    if not user32.RegisterHotKey(None, idx, modifiers, vk):
        print("Unable to register id", idx)
