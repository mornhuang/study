...
insert into holiday values('0626','国际禁毒日(国际反毒品日)[1987] 禁止药物滥用和非法贩运国际日[1987] 国际宪章日(联合国宪章日)[1945] 支援酷刑受害者国际日[1997]','0');  
...
insert into choliday values('0415','佛吉祥日——释迦牟尼佛诞生、成道、涅槃三期同一庆(即南传佛教国家的卫塞节)','0');  
