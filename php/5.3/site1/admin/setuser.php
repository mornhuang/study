...
elseif($action == 'search')
{
	...
	$rurl = "$admin_file?adminjob=setuser&action=$action&schname=" . urlencode($schname) . "&schemail=$schemail&regdate=$regdate&orderway=$orderway&lines=$lines&";
...
elseif($action == 'edit')
{
	...
	if($step != '2')
	{
		...
		$regdate = get_date($regdate, 'Y-n-j H:i:s');
