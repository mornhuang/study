...
function updatecache_level()
{
	...
	while(@extract($db->fetch_array($query)))
	{
		...
		if($gptype == 'member')
		{
			$memdb .= "\$ltitle[$gid]=" . pv_var_export($grouptitle) . ";\t\t\$lpic[$gid]=" . pv_var_export($groupimg) . ";\t\t\$lneed[$gid]=" . pv_var_export($grouppost) . ";\r\n";
		}
		elseif($gptype == 'system')
		{
			$sysdb .= "\$ltitle[$gid]=" . pv_var_export($grouptitle) . ";\t\t\$lpic[$gid]=" . pv_var_export($groupimg) . ";\r\n";
		}
		elseif($gptype == 'default')
		{
			$defaultdb .= "\$ltitle[$gid]=" . pv_var_export($grouptitle) . ";\t\t\$lpic[$gid]=" . pv_var_export($groupimg) . ";\r\n";
		}
	}
