...
<dt>推荐影片</dt>
<dd class="h395">
<ul class="sv"><?php $videodb = pv_loop('video',"best=1|limit=10|order=lastdate DESC,postdate DESC,v.vid DESC"); if(is_array($videodb)) { foreach($videodb as $video) { ?><li>
...
<dt>最近更新</dt>
<dd class="h395 numbg">
<ul class="vl"><?php $i=1; $videodb = pv_loop('video',"cid=-1|limit=10|order=lastdate DESC,postdate DESC,v.vid DESC"); if(is_array($videodb)) { foreach($videodb as $video) { if($i==1) { ?>
<li class="l1">
...
</div><?php $adcode = ad('index',1); if($adcode!='') { ?><div class="adindex"><?php echo $adcode;?></div><?php } $adi=2; $c1db = pv_loop('class',"cid=0"); if(is_array($c1db)) { foreach($c1db as $c1) { ?><div class="w960 mt15 fl">
<div class="w700 fl">
<dl class="box">
<dt>
<span class="fr fz12"><?php $c2db = pv_loop('class',"cid=$c1[cid]"); if(is_array($c2db)) { foreach($c2db as $c2) { ?>&nbsp;&nbsp;<a href="class.php?cid=<?php echo $c2['cid'];?>"><?php echo $c2['caption'];?></a><?php } } ?></span>
<?php echo $c1['caption'];?>
</dt>
<dd class="h395">
...
<ul class="vl"><?php $i=1; $videodb = pv_loop('video',"cid=$c1[cid]|showsub=1|order=$t DESC,hits DESC,v.vid DESC|limit=10|cachetime=1d"); if(is_array($videodb)) { foreach($videodb as $video) { if($i==1) { ?>
<li class="l1">
<a class="imgbg1" href="read.php?vid=<?php echo $video['vid'];?>" title="<?php echo $video['subject'];?>"><img src="<?php echo $video['picurl'];?>" alt="<?php echo $video['subject'];?>"/><span class="num1"></span></a>
<p class="subject"><a href="read.php?vid=<?php echo $video['vid'];?>" title="<?php echo $video['subject'];?>"><?php echo $video['subject'];?></a></p>
<p>类别: <?php echo $video['class_name'];?></p>
...
</div><?php $adcode = ad('index',$adi); $adi++; if($adcode!='') { ?><div class="adindex"><?php echo $adcode;?></div><?php } } } if($db_indexlink=='1') { ?>
